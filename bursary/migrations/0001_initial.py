# Generated by Django 6.0.1 on 2026-05-11 12:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('disability_document', models.FileField(blank=True, null=True, upload_to='disability_docs/')),
                ...
                ('father_death_doc', models.FileField(blank=True, null=True, upload_to='family_docs/')),
                ('mother_death_no', models.CharField(blank=True, max_length=50, null=True)),
                ('mother_death_doc', models.FileField(blank=True, null=True, upload_to='family_docs/')),
                ...
                ('status', models.CharField(choices=[('pending', 'Pending'), ('approved', 'Approved'), ('unsuccessful', 'Unsuccessful')], default='pending', max_length=20)),
